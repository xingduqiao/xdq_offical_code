var zbp = new ZBP({
	bloghost: "http://www.birdol.com/",
	ajaxurl: "http://www.birdol.com/zb_system/cmd.php?act=ajax&src=",
	cookiepath: "/"
});
...
function notify(s){
	if (window.webkitNotifications) {
		if (window.webkitNotifications.checkPermission() == 0) {
			var zb_notifications = window.webkitNotifications.createNotification('http://www.birdol.com/zb_system/image/admin/logo-16.png', '通知', s);
...
function statistic(s){
	$("#statloading").show();
	$("#updatatime").hide();
	$.get("http://www.birdol.com/zb_system/cmd.php"+s+"&tm="+Math.random(),{},
		function(data){
...
$(document).ready(function(){
	...
	if ($("div.divHeader,div.divHeader2").first().css("background-image") == "none") { 
		AddHeaderIcon("http://www.birdol.com/zb_system/image/common/window.png");
	}
...
//return false;
    ...
    return false;
}  ;var zcenter_userurl= "http://www.birdol.com/user/";
