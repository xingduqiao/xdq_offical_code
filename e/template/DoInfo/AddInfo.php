...
<form name="add" method="POST" enctype="multipart/form-data" action="ecms.php" onsubmit="return EmpireCMSQInfoPostFun(document.add,'<?=$mid?>');">
  ...
  <table class="table table-bordered table-hover table-striped" width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
          <tr class="header"> 
  ...
  <table class="table table-bordered table-hover table-striped" width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
    ...
    <tr class="header"> 
      <td width="16%">&nbsp;</td>
      <td><input type="submit" name="addnews" value="提交" class="btn btn-primary"> <input type="reset" name="Submit2" value="重置" class="btn btn-primary"></td>
    </tr>
  </table>
</form></div>
<?php
