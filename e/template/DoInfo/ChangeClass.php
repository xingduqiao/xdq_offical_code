...
function CheckChangeClass()
{
	...
	return true;
      ...
      <table class="table table-bordered table-hover table-striped" width="500" border="0" align="center">
        <tr> 
          <td>你好，<b><?=$musername?></b></td>
        </tr>
      </table>
      <table class="table table-bordered table-hover table-striped" width="500" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        <form action="AddInfo.php" method="get" name="changeclass" id="changeclass" onsubmit="return CheckChangeClass();">
          ...
          <tr bgcolor="#FFFFFF"> 
            <td><input type="submit" name="Submit" value="添加信息" class="btn btn-primary"> <font color="#666666">(请选择终极栏目[蓝色条])</font></td>
          </tr>
        </form>
      </table></div>
<?php
