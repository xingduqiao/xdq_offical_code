  ...
  for (var i=0;i<form.elements.length;i++)
    ...
    if (e.name != 'chkall')
  	...
  	<div class="app-content-body ">
        <table class="table table-bordered table-hover table-striped" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		?>
          <tr> 
            <td height="25">
			<table class="table table-bordered table-hover table-striped" width="100%" border="0" cellspacing="1" cellpadding="3"<?=$bgcolor?>>
                <tr> 
                ...
                <tr> 
                  <td>&nbsp;</td>
                  <td colspan="2"> <table class="table table-bordered table-hover table-striped" border=0 width=100% cellspacing=1 cellpadding=10 bgcolor='#cccccc'>
                      <tr> 
					...
					{
					?>
                    <table class="table table-bordered table-hover table-striped" width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
                      <tr> 
          ...
          <tr> 
            <td height="23"> 
              <table class="table table-bordered table-hover table-striped" width="100%" border="0" cellspacing="1" cellpadding="3">
                <tr>
                  <td width="5%"><div align="center"><input type='checkbox' name='chkall' value='on' onClick='CheckAll(this.form)'></div></td>
                  <td width="95%">
                    <?=$returnpage?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' class="btn btn-primary" name='submit' value='批量删除'>
