...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>购买内容需要点数</td><td bgcolor='ffffff'>
<input name="point" type="text" id="point" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[point]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>下载地址</td><td bgcolor='ffffff'>
<textarea name="sfnr" cols="60" rows="10" id="sfnr"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[sfnr]))?></textarea>
