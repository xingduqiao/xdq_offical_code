...
<title>物业管理事务智慧库_<?=$public_r[sitename]?></title>
...
?> 
    ...
    <!-- banner -->
        ...
        <section class="inside-pages-banner">
            <div class="ipb-pic"><img src="/skin/default/nyban0.jpg" /></div>
            <div class="ipb-words">
                <h1 class="iwt1">物业管理事务智慧库</h1>
...
<? @sys_GetSitelink(8,30,0,0,0);?>
            ...
            <div class="footer-company-infor clearfix">
                <div class="fci-left">
                    <p>主办单位：杭州星渡桥信息技术有限公司  </p><p>地址：浙江省杭州市滨江区浦沿街道南环路4280号1幢328室 &nbsp; 电话：<a href="tel:4006869186">400-686-9186</a> &nbsp; 邮箱：
