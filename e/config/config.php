...
$ecms_config['db']['dbserver']='hdm721908431.my3w.com';	//数据库登录地址
$ecms_config['db']['dbport']='';	//端口，不填为按默认
$ecms_config['db']['dbusername']='hdm721908431';	//数据库用户名
$ecms_config['db']['dbpassword']='xdq@123789';	//数据库密码
$ecms_config['db']['dbname']='hdm721908431_db';	//数据库名
...
//后台安全设置
$ecms_config['esafe']['loginauth']='2049';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['enloginauth']=0;	//登录认证码加密验证串有效时间,单位:秒(0为不启用加密)
$ecms_config['esafe']['ecookiernd']='2IlWGyJxgBP2hKM8xk4w7dyFRYlxDAwSE8BE';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='kfvfh';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='wlpku';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='XaA6cgMM6ZDNRQAGKjtrSSMfOqmEJJa3yBe';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='GaSMU92uDod9E01T5n1LaYw0L8x8xBln26';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='4Iwf0iA6Q3bVQdKiPaysu8rXk9c37EPHd';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='h1MNMJk4TeunzFFgKWrjmeUMctAUHuhi';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='KGng3x9xuzKqXa4ISqMSB8PcTmWWSDF';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'59eAj656JR9pZIykTU4ilhEVtYwQYXuW',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/xxdh/\">星星渡河</a>&nbsp;|&nbsp;<a href=\"/team/\">团队阵容</a>&nbsp;|&nbsp;<a href=\"/cpzs/\">产品展示</a>&nbsp;|&nbsp;<a href=\"/wyxxp/\">物业选续聘</a>&nbsp;|&nbsp;<a href=\"/flgf/\">法律规范</a>&nbsp;|&nbsp;<a href=\"/dgfw/\">订购服务</a>&nbsp;|&nbsp;<a href=\"/xmzx/\">项目资讯</a>&nbsp;|&nbsp;<a href=\"/zhpt/\">智慧平台</a>&nbsp;|&nbsp;<a href=\"/jmwm/\">加盟我们</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'SZVdZWFzYyvFQxeHZ6T3CCPs0ff27urvfiuH',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'tmJimCkzQQX4rpgYqnabqKyTJIwBpW3lj8lmowTTfC',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,point,sfnr,special.field,newstime,titlepic,smalltext,writer,befrom,newstext,',
'qenter'=>',title,ftitle,point,sfnr,special.field,titlepic,smalltext,writer,befrom,newstext,',
'listtempf'=>',title,ftitle,point,newstime,titlepic,smalltext,diggtop,',
'tempf'=>',title,ftitle,point,sfnr,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,smalltext,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,newstext,',
'canaddf'=>',title,ftitle,point,sfnr,newstime,titlepic,smalltext,writer,befrom,newstext,',
'caneditf'=>',title,ftitle,point,sfnr,newstime,titlepic,smalltext,writer,befrom,newstext,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,point,quanxian,',
'tbdataf'=>',writer,befrom,newstext,sfnr,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,point,quanxian,sfnr,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|4|7|13|24|25|26|27|33|',
'maddfun'=>'',
'meditfun'=>'',
'qmaddfun'=>'',
'qmeditfun'=>'',
