...
<html>
	...
	<body>
		...
		<div class="m_nav_iframe">
			...
			if(!$b)
			{
				$notrecordword="<li><a href='javascript:;' data-url='other/MenuClass.php".$ecms_hashur['whehref']."'><i class='icon icon-angle-right'></i> <span>添加常用菜单</span></a></li>";
				echo"<li><h4><i class='icon icon-cog'></i> <span>常用菜单管理</span> <i class='icon icon-double-angle-right'></i></h4><ol><li>$notrecordword</li></ol></li>";
			}
			?>
			</ul>
		</div>
