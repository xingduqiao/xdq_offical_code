...
function(t) {
    ...
    e.prototype.setState = function(e) {
        ...
        a = n.data();
        e += "Text",
        a.resetText || n.data("resetText", n[o]()),
        n[o](a[e] || this.options[e]),
    ...
    t.fn.button = function(i) {
        return this.each(function() {
            ...
            o = n.data("zui.button"),
            a = "object" == typeof i && i;
            o || n.data("zui.button", o = new e(this, a)),
...
function(t) {
    ...
    n.prototype.close = function(e) {
        ...
        e.isDefaultPrevented() || (s.removeClass("in"), t.support.transition && s.hasClass("fade") ? s.one(t.support.transition.end, n).emulateTransitionEnd(150) : n())
    };
    var o = t.fn.alert;
    t.fn.alert = function(e) {
        return this.each(function() {
            var o = t(this),
            a = o.data(i);
            a || o.data(i, a = new n(this)),
            "string" == typeof e && a[e].call(o)
        })
    },
...
function(t) {
    ...
    o = function(i, a) {
        ...
        s.name = e,
        s.$ = t(i),
        a = s.options = t.extend({},
        o.DEFAULTS, this.$.data(), a);
        var r = a.lang || "zh_cn";
        s.lang = t.isPlainObject(r) ? t.extend(!0, {},
        n[r.lang || t.zui.clientLang()], r) : n[r],
        s.state = {},
        s.set(a.page, a.recTotal, a.recPerPage),
        s.$.on("click", ".pager-goto-btn",
        function() {
        ...
        }).on("click", ".pager-size-menu [data-size]",
        function() {
    ...
    o.prototype.set = function(e, n, o) {
        ...
        a.state = s,
        r.page === s.page && r.recTotal === s.recTotal && r.recPerPage === s.recPerPage || a.$.callComEvent(a, "onPageChange", [s, r]),
        a.render()
    },
    o.prototype.createLinkItem = function(e, i, n) {
        ...
        return n || (a = t("<li />").append(a).toggleClass("active", e === o.state.page).toggleClass("disabled", !e)),
        a
    },
    o.prototype.createNavItems = function(t) {
        ...
        void 0 === t && (t = e.options.maxNavCount || 10),
        s(1),
        o > 1 && (o <= t ? s(2, o) : a < t - 2 ? (s(2, t - 2), s(!1), s(o)) : a > o - t + 2 ? (s(!1), s(o - t + 2, o)) : (s(!1), s(a - Math.ceil((t - 4) / 2), a + Math.floor((t - 4) / 2)), s(!1), s(o)))
    },
    ...
    o.prototype.createLink = function(e, i) {
        ...
        return "string" == typeof n ? n.format(t.extend({},
        i, {
            page: e
    ...
    o.prototype.render = function(e) {
        ...
        a = t.isPlainObject(o);
        e = e || i.elements || i.options.elements,
        ...
        for (var s = 0; s < e.length; ++s) {
            ...
            l = a ? o[r] || o: o,
            c = l.call(i, r, i.$, n);
            c === !1 && (c = i.createElement(r, i.$, n)),
            c instanceof t && ("LI" !== c[0].tagName && (c = t("<li/>").append(c)), i.$.append(c))
        }
        var d = null;
        return i.$.children("li").each(function() {
            var e = t(this),
            i = !!e.children(".pager-item").length;
            d ? d.toggleClass("pager-item-right", !i) : i && e.addClass("pager-item-left"),
            d = i ? e: null
        }),
        i.$.callComEvent(i, "onRender", [n]),
        i
    },
    o.DEFAULTS = t.extend({
    ...
    i),
    t.fn.pager = function(i) {
        return this.each(function() {
            var n = t(this),
            a = n.data(e),
            s = "object" == typeof i && i;
            a || n.data(e, a = new o(this, s)),
            "string" == typeof i && a[i]()
        })
    },
    o.NAME = e,
    t.fn.pager.Constructor = o,
    t(function() {
...
function(t) {
    ...
    i.prototype.activate = function(e, i, n) {
        ...
        s ? a.one(t.support.transition.end, o).emulateTransitionEnd(150) : o(),
        a.removeClass("in")
    };
    var n = t.fn.tab;
    t.fn.tab = function(n) {
...
function(t) {
    ...
    i.prototype.show = function() {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(i), !i.isDefaultPrevented()) {
                ...
                var s = function() {
                    this.$element.removeClass("collapsing").addClass("in")[a]("auto"),
    ...
    t.fn.collapse = function(n) {
        return this.each(function() {
            ...
            a = o.data(e),
            s = t.extend({},
            i.DEFAULTS, o.data(), "object" == typeof n && n);
            a || o.data(e, a = new i(this, s)),
            "string" == typeof n && a[n]()
        })
    },
    ...
    function(i) {
        ...
        d = c && t(c);
        r && r.transitioning || (d && d.find('[data-toggle=collapse][data-parent="' + c + '"]').not(o).addClass("collapsed"), o[s.hasClass("in") ? "addClass": "removeClass"]("collapsed")),
        s.collapse(l)
    })
} (window.jQuery),
function(t, e) {
    ...
    l.match(/(iPad|iPhone|iPod)/i) ? r += " os-ios": l.match(/android/i) ? r += " os-android": l.match(/Win/i) ? r += " os-windows": l.match(/Mac/i) ? r += " os-mac": l.match(/Linux/i) ? r += " os-linux": l.match(/X11/i) && (r += " os-unix"),
    "ontouchstart" in document.documentElement && (r += " is-touchable"),
    e("html").addClass(r),
    a.resize(s),
    s()
} (window, jQuery),
function(t) {
    ...
    i.prototype.cssHelper = function() {
        ...
        e && i.addClass("ie-" + e).toggleClass("gt-ie-7 gte-ie-8 support-ie", e >= 8).toggleClass("lte-ie-7 lt-ie-8 outdated-ie", e < 8).toggleClass("gt-ie-8 gte-ie-9", e >= 9).toggleClass("lte-ie-8 lt-ie-9", e < 9).toggleClass("gt-ie-9 gte-ie-10", e >= 10).toggleClass("lte-ie-9 lt-ie-10", e < 10)
    },
    i.prototype.tip = function(i) {
        var n = t("#browseHappyTip");
        n.length || (n = t('<div id="browseHappyTip" class="alert alert-dismissable alert-danger-inverse alert-block" style="position: relative; z-index: 99999"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><div class="container"><div class="content text-center"></div></div></div>'), n.prependTo("body")),
        n.find(".content").html(i || this.browseHappyTip || e[t.zui.clientLang() || "zh_cn"])
    },
...
function() {
    ...
    Date.create || (Date.create = function(t) {
        return t instanceof Date || ("number" == typeof t && t < 1e10 && (t *= 1e3), t = new Date(t)),
        t
    }),
    Date.timestamp || (Date.timestamp = function(t) {
        return "number" == typeof t ? t < 1e10 && (t *= 1e3) : t = Date.create(t).getTime(),
        t
    })
} (),
function() {
    ...
    String.prototype.endsWith || (String.prototype.endsWith = function(t, e) {
        var i = this.toString(); (void 0 === e || e > i.length) && (e = i.length),
        e -= t.length;
        var n = i.indexOf(t, e);
        return n !== -1 && n === e
    }),
...
function(t) {
    ...
    function e(n, o) {
        ...
        this.$body = t("body"),
        this.$scrollElement = this.$element.on("scroll." + i + ".data-api", s),
        this.options = t.extend({},
        e.DEFAULTS, o),
        this.selector || (this.selector = (this.options.target || (a = t(n).attr("href")) && a.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a"),
        this.offsets = t([]),
        this.targets = t([]),
    ...
    i = function(e, n) {
        ...
        if (a.length) {
            ...
            r = function() {
                ...
                if (t !== o.lastValue) {
                    var e = "" === t;
                    a.toggleClass("empty", e),
                    o.$.callComEvent(o, "onSearchChange", [t, e]),
                    o.lastValue = t
                }
            };
            o.$input = a = a.first(),
            o.lastValue = o.getSearch(),
            a.on(n.listenEvent,
            function(t) {
            ...
            function(t) {
                a.addClass("focus"),
                o.$.callComEvent(o, "onFocus", [t])
            }).on("blur",
            function(t) {
                a.removeClass("focus"),
                o.$.callComEvent(o, "onBlur", [t])
            }).on("keydown",
            function(t) {
                var e = 0,
                i = t.witch;
...
function(t, e) {
    ...
    a.prototype.init = function() {
        ...
        $ = function(t) {
            ...
            w.removeClass("drag-ready").addClass("dragging"),
            v.move && (C ? v.move(o, w) : w.css(o)),
            v[p] && v[p]({
                event: t,
                element: w,
                startOffset: a,
            ...
            s.x = e,
            s.y = i,
            v.stopPropagation && t.stopPropagation()
        },
        x = function(i) {
            ...
            w.removeClass("drag-ready dragging"),
            v.move && (C ? v.move(o, w) : w.css(o)),
            v[h] && v[h]({
                event: i,
                element: w,
            ...
            i.preventDefault(),
            v.stopPropagation && i.stopPropagation()
        },
        T = function(i) {
    ...
    s.prototype.init = function() {
        ...
        j = function(e) {
            ...
            !(i.abs(f.left - p.left) < w && i.abs(f.top - p.top) < w))) {
                if (null === s) {
                    ...
                    "absolute" != n && "relative" != n && "fixed" != n && (c = n, M.css("position", "relative")),
                    s = P.clone().removeClass("drag-from").addClass("drag-shadow").css({
                        position: "absolute",
                        width: P.outerWidth(),
                        transition: "none"
                    }).appendTo(M),
                ...
                if (o.each(function() {
                    ...
                    var $ = C.data("id");
                    P.data("id") != $ && (l = !1),
                    (null === a || a.data("id") !== $ && !l) && (y = !0),
                    a = C,
                    E && o.removeClass("drop-to"),
                    a.addClass("drop-to")
                }
                E ? null !== a && a.length && (r = !0) : (P.toggleClass("drop-in", r), s.toggleClass("drop-in", r)),
                z && z(P, a) === !1 || v.trigger("drag", {
                    event: e,
                    isIn: r,
                    target: a,
                    element: P,
        ...
        L = function(i) {
            if (t(e).off(C), clearTimeout(m), I) {
                if (I = !1, c && M.css("position", c), null === s) return P.removeClass("drag-from"),
                void v.trigger("always", {
                    event: i,
                    cancel: !0
                });
                r || (a = null);
                ...
                n = v.trigger("beforeDrop", y),
                n && r && v.trigger("drop", y),
                o.removeClass("drop-to"),
                P.removeClass("dragging").removeClass("drag-from"),
                s.remove(),
                s = null,
                v.trigger("finish", y),
                v.trigger("always", y),
        ...
        O = function(i) {
            ...
            if (! (n > -1 && i.button !== n)) {
                var f = t(this);
                k && (P = D ? f.closest(k) : f),
                P.hasClass("drag-shadow") || b.before && b.before({
                    event: i,
                    element: P
...
function(t) {
    ...
    function e(e, o, a) {
        return this.each(function() {
            ...
            r = s.data(i),
            l = t.extend({},
            n.DEFAULTS, s.data(), "object" == typeof e && e);
            r || s.data(i, r = new n(this, l)),
            "string" == typeof e ? r[e](o, a) : l.show && r.show(o, a)
        })
    }
    var i = "zui.modal",
    n = function(e, n) {
        var o = this;
        o.options = n,
        o.$body = t(document.body),
        o.$element = t(e),
        o.$backdrop = o.isShown = null,
        o.scrollbarWidth = 0,
        void 0 === n.moveable && (o.options.moveable = o.$element.hasClass("modal-moveable")),
        n.remote && o.$element.find(".modal-content").load(n.remote,
        function() {
    ...
    var o = function(e, i) {
        var n = t(window);
        i.left = Math.max(0, Math.min(i.left, n.width() - e.outerWidth())),
        i.top = Math.max(0, Math.min(i.top, n.height() - e.outerHeight())),
        e.css(i)
    };
    ...
    n.prototype.ajustPosition = function(e) {
        ...
        if ("undefined" == typeof e && (e = a.position), "undefined" != typeof e) {
            ...
            if (s.hasClass("modal-moveable")) {
                var c = null,
                d = a.rememberPos;
                d && (d === !0 ? c = n.$element.data("modal-pos") : t.zui.store && (c = t.zui.store.pageGet(i + ".rememberPos." + d))),
                c || (c = {
    ...
    n.prototype.setMoveale = function() {
        ...
        a.toggleClass("modal-moveable", !!n.moveable),
        e.$element.data("modal-moveable-setup") || a.draggable({
            container: e.$element,
            handle: ".modal-header",
            before: function() {
    ...
    n.prototype.show = function(e, o) {
        ...
        a.$element.trigger(s),
        a.isShown || s.isDefaultPrevented() || (a.isShown = !0, a.options.moveable && a.setMoveale(), a.checkScrollbar(), a.$body.addClass("modal-open"), a.setScrollbar(), a.escape(), a.$element.on("click.dismiss." + i, '[data-dismiss="modal"]', t.proxy(a.hide, a)), a.backdrop(function() {
            ...
            s ? a.$element.find(".modal-dialog").one("bsTransitionEnd",
            function() {
...
function(t, e) {
    ...
    s = function(e, i) {
        e = t.extend({},
        s.DEFAULTS, t.ModalTriggerDefaults, i ? i.data() : null, e),
        this.isShown,
        this.$trigger = i,
        this.options = e,
        this.id = t.zui.uuid()
    ...
    s.prototype.init = function(s) {
        var r = this;
        if (s.url && (!s.type || s.type != n && "iframe" != s.type) && (s.type = n), s.remote) s.type = n,
        typeof s.remote === a && (s.url = s.remote);
        else if (s.iframe) s.type = "iframe",
        typeof s.iframe === a && (s.url = s.iframe);
    ...
    s.prototype.show = function(o) {
        ...
        l.toggleClass("fade", s.fade).addClass(s.className).toggleClass("modal-loading", !this.isShown),
        c.toggleClass("modal-md", "md" === s.size).toggleClass("modal-sm", "sm" === s.size).toggleClass("modal-lg", "lg" === s.size).toggleClass("modal-fullscreen", "fullscreen" === s.size),
        h.toggle(s.showHeader),
        h.find(".modal-icon").attr("class", "modal-icon icon-" + s.icon),
        h.find(".modal-title-name").text(s.title || ""),
        s.size && "fullscreen" === s.size && (s.width = "", s.height = "");
        var f = function() {
        ...
        g = function(t, e) {
            return "undefined" == typeof t && (t = s.delay),
            setTimeout(function() {
                c = l.find(".modal-dialog"),
                s.width && "auto" != s.width && c.css("width", s.width),
                s.height && "auto" != s.height && (c.css("height", s.height), "iframe" === s.type && p.css("height", c.height() - h.outerHeight())),
                r.ajustPosition(s.position),
                l.removeClass("modal-loading"),
                "iframe" != s.type && c.off("resize." + i).on("resize." + i, f),
                e && e()
            },
            t)
        };
        if ("custom" === s.type && d) if (t.isFunction(d)) {
            ...
            if (l.attr("ref", s.url), "iframe" === s.type) {
                ...
                h.detach(),
                p.detach(),
                u.empty().append(h).append(p),
                p.css("padding", 0).html('<iframe id="' + y + '" name="' + y + '" src="' + s.url + '" frameborder="no"  allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"  allowtransparency="true" scrolling="auto" style="width: 100%; height: 100%; left: 0px;"></iframe>'),
                s.waittime > 0 && (r.waitTimeout = g(s.waittime, v));
                var b = document.getElementById(y);
                b.onload = b.onreadystatechange = function() {
                    if (r.firstLoad && l.addClass("modal-loading"), !this.readyState || "complete" == this.readyState) {
                        r.firstLoad = !1,
                        s.waittime > 0 && clearTimeout(r.waitTimeout);
                        try {
                            ...
                            if (t && "auto" === s.height && "fullscreen" != s.size) {
                                ...
                                var o = function(t) {
                                    l.removeClass("fade");
                                    var e = n.outerHeight();
                                    t === !0 && s.onlyIncreaseHeight && (e = Math.max(e, p.data("minModalHeight") || 0), p.data("minModalHeight", e)),
                                    p.css("height", e),
                                    s.fade && l.addClass("fade"),
                                    g()
                                };
    ...
    s.prototype.close = function(i, n) { (i || n) && this.$modal.on("hidden" + o,
        function() {
            t.isFunction(i) && i(),
            typeof n === a && ("this" === n ? e.location.reload() : e.location = n)
        }),
    ...
    t.fn.modalTrigger = function(e, n) {
        return t(this).each(function() {
            ...
            typeof e == a ? r[e](n) : l.show && r.show(n),
            o.on((l.trigger || "click") + ".toggle." + i,
            function(t) {
                r.toggle(l),
    ...
    var l = function(e) {
        var i = typeof e;
        return "undefined" === i ? e = t(".modal.modal-trigger") : i === a && (e = t(e)),
        e && e instanceof t ? e: null
    },
    c = function(e, n, o) {
        if (t.isFunction(e)) {
            var a = o;
    ...
    d = function(t, e) {
        e = l(e),
        e && e.length && e.modal("ajustPosition", t)
    };
    t.zui({
        closeModal: c,
...
function(t) {
    ...
    e.prototype.show = function(e) {
        ...
        if ((e || this.hasContent()) && this.enabled) {
            ...
            var o = n.tip();
            n.setContent(e),
            n.options.animation && o.addClass("fade");
            ...
            n.options.container ? o.appendTo(n.options.container) : o.insertAfter(n.$element);
            var l = n.getPosition(),
            c = o[0].offsetWidth,
            d = o[0].offsetHeight;
            if (r) {
                ...
                a = "bottom" == a && l.top + l.height + d - u > g ? "top": "top" == a && l.top - u - d < 0 ? "bottom": "right" == a && l.right + c > f ? "left": "left" == a && l.left - c < m ? "right": a,
            ...
            var y = function() {
                var t = n.hoverState;
                n.$element.trigger("shown.zui." + n.type),
                n.hoverState = null,
                "out" == t && n.leave(n)
            };
    ...
    e.prototype.applyPlacement = function(t, e) {
        ...
        t.top = t.top + s,
        t.left = t.left + r,
        n.offset(t).addClass("in");
        var l = n[0].offsetWidth,
        c = n[0].offsetHeight;
        if ("top" == e && c != a && (i = !0, t.top = t.top + a - c), /bottom|top/.test(e)) {
            var d = 0;
            t.left < 0 && (d = t.left * -2, t.left = 0, n.offset(t), l = n[0].offsetWidth, c = n[0].offsetHeight),
...
function(t) {
    ...
    t.fn.popover = function(i) {
        return this.each(function() {
            ...
            a = "object" == typeof i && i;
            o || n.data("zui.popover", o = new e(this, a)),
            "string" == typeof i && o[i]()
        })
    },
...
function(t) {
    ...
    s.prototype.toggle = function(o) {
        ...
        if (!a.is(".disabled, :disabled")) {
            ...
            if (e(), !r) {
                ...
                s.toggleClass("open").trigger("shown." + n),
                a.focus()
            }
            return ! 1
        }
    ...
    s.prototype.keydown = function(e) {
        if (/(38|40|27)/.test(e.keyCode)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !n.is(".disabled, :disabled")) {
                var o = i(n),
                s = o.hasClass("open");
                if (!s || s && 27 == e.keyCode) return 27 == e.which && o.find(a).focus(),
                n.click();
    ...
    t.fn.dropdown = function(e) {
        return this.each(function() {
            var i = t(this),
            n = i.data("dropdown");
            n || i.data("dropdown", n = new s(this)),
...
function(t, e) {
    ...
    l = 0,
    c = function() {
        return t(document).off("mousemove." + i).on("mousemove." + i,
        function(t) {
            r = t.clientX,
            l = t.clientY
        }),
    ...
    d = function(e, i) {
        ...
        return e.html ? n.html(e.html === !0 ? e.label || e.text: e.html) : n.text(e.label || e.text),
        e.onClick && n.on("click", e.onClick),
        t("<li />").toggleClass("disabled", e.disabled === !0).append(n)
    },
    p = null,
    h = function(e, i) {
        ...
        if (n.length) {
            ...
            if (!e || o.id === e) {
                ...
                var l = o.animation;
                n.removeClass("in"),
                l ? p = setTimeout(r, o.duration) : r()
            }
        }
        return a
    },
    u = function(c, u, f) {
        t.isPlainObject(c) && (f = u, u = c, c = u.items),
        o = !0,
        u = t.extend({},
        n, u);
        var g = u.x,
        m = u.y;
        g === e && (g = (u.event || u).clientX),
        g === e && (g = r),
        m === e && (m = (u.event || u).clientY),
        m === e && (m = l);
        var v = t("#" + s);
        ...
        var y = v.find(".contextmenu-menu").off("click." + i).on("click." + i, "a",
        function(e) {
            var i = t(this),
        ...
        w = typeof c;
        "string" === w ? c = c.split(",") : "function" === w && (c = c(u)),
        t.each(c,
        function(t, e) {
            y.append(b(e, t, u))
        });
        ...
        var T = t(window);
        return g = Math.max(0, Math.min(g, T.width() - y.outerWidth())),
        m = Math.max(0, Math.min(m, T.height() - y.outerHeight())),
        v.css({
            left: g,
            top: m
        }),
    ...
    var f = function(e, n) {
        ...
        var r = function(t) {
            if ("mousedown" !== t.type || 2 === t.button) {
                ...
                return n.itemsCreator && (e.items = n.itemsCreator.call(this, t)),
                o.show(e),
                t.preventDefault(),
                t.returnValue = !1,
                !1
...
function(t) {
    ...
    e.prototype.touchable = function() {
        function e(e) {
            ...
            case "touchend":
                ...
                if (Math.abs(s) > Math.abs(r)) i(a, s),
                Math.abs(s) > 10 && e.preventDefault();
                else {
                    var l = t(window);
                    t("body,html").animate({
    ...
    e.prototype.to = function(e) {
        ...
        if (! (e > this.$items.length - 1 || e < 0)) return this.sliding ? this.$element.one("slid",
        function() {
            i.to(e)
    ...
    e.prototype.slide = function(e, i) {
        ...
        if (!o.hasClass("active")) {
            ...
            function() {
                ...
                n.addClass(s),
                o.addClass(s),
                n.one(t.support.transition.end,
                function() {
    ...
    t.fn.carousel = function(i) {
        return this.each(function() {
            ...
            o || n.data("zui.carousel", o = new e(this, a)),
            "number" == typeof i ? o.to(i) : s ? o[s]() : a.interval && o.pause().cycle(),
            a.touchable && o.touchable()
        })
    },
    ...
    t(document).on("click.zui.carousel.data-api", "[data-slide], [data-slide-to]",
    function(e) {
        var i, n = t(this),
        ...
        s && (a.interval = !1),
        o.carousel(a),
        (s = n.attr("data-slide-to")) && o.data("zui.carousel").to(s),
        e.preventDefault()
    }),
    t(window).on("load",
    function() {
...
function(t) {
    ...
    t.zui.imgReady = function() {
        ...
        e = null,
        i = function() {
            for (var e = 0; e < t.length; e++) t[e].end ? t.splice(e--, 1) : t[e](); ! t.length && n()
        },
        n = function() {
            clearInterval(e),
            e = null
        ...
        return function(n, o, a, s) {
            ...
            return h.src = n,
            h.complete ? (o.call(h), void(a && a.call(h))) : (l = h.width, c = h.height, h.onerror = function() {
                s && s.call(h),
                r.end = !0,
            ...
            r = function() {
                d = h.width,
                p = h.height,
                (d !== l || p !== c || d * p > 1024) && (o.call(h), r.end = !0)
            },
            r(), h.onload = function() { ! r.end && r(),
                a && a.call(h),
                h = h.onload = h.onerror = null
            },
...
function(t, e, i) {
    ...
    n.prototype.getOptions = function(e) {
        ...
        e[i] || (e[i] = this.$.attr("src") || this.$.attr("href") || this.$.find("img").attr("src"), this.$.data(i, e[i])),
        e
    },
    ...
    n.prototype.setImage = function(t, e) {
        void 0 !== t && (this.options.image = t),
        void 0 !== e && (this.options.caption = e)
    },
    ...
    n.prototype.bindEvents = function() {
        ...
        return !! a.image && void n.modalTrigger({
            ...
            custom: function(n) {
                ...
                d = t(e).width();
                t.zui.imgReady(a.image,
                function() {
                    c.css({
                        width: i.min(d, this.width)
                    }),
                    d < this.width + 30 && s.addClass("lightbox-full"),
                    n.ready(200)
                }),
                s.find(".prev").toggleClass("show", r.filter('[data-group-index="' + (l - 1) + '"]').length > 0),
                s.find(".next").toggleClass("show", r.filter('[data-group-index="' + (l + 1) + '"]').length > 0),
                s.find(".controller").click(function() {
                    var o = t(this),
                    ...
                    if (l.length) {
                        var p = l.data("image"),
                        h = l.data("caption");
                        s.addClass("modal-loading").data("group-index", a).toggleClass("lightbox-with-caption", "string" == typeof h).removeClass("lightbox-full"),
                        s.find(".lightbox-img").attr("src", p),
                        s.find(".caption > .content").text(h),
                        d = t(e).width(),
                        t.zui.imgReady(p,
                        function() {
                            c.css({
                    ...
                    return s.find(".prev").toggleClass("show", r.filter('[data-group-index="' + (a - 1) + '"]').length > 0),
                    s.find(".next").toggleClass("show", r.filter('[data-group-index="' + (a + 1) + '"]').length > 0),
                    !1
                })
            }
        })
    ...
    t.fn.lightbox = function(e) {
        ...
        return this.each(function() {
            var o = t(this),
            a = "object" == typeof e && e;
            "object" == typeof a && a.group ? o.attr("data-lightbox-group", a.group) : o.data("group") ? o.attr("data-lightbox-group", o.data("group")) : o.attr("data-lightbox-group", i),
            o.data("group", o.data("lightbox-group"));
            var s = o.data("zui.lightbox");
            s || o.data("zui.lightbox", s = new n(this, a)),
            "string" == typeof e && s[e]()
        })
    },
    t.fn.lightbox.Constructor = n,
    t(function() {
...
function(t, e, i) {
    ...
    r = function(e, r) {
        ...
        h = function(e) {
            var n = t('');
            "close" === e.name && n.addClass("close"),
            e.html !== i && n.html(e.html),
            e.icon !== i && n.append(''),
            e.text !== i && n.append(''),
            e.tooltip !== i && n.attr("title", e.tooltip).tooltip(),
            n.data("action", e),
            p.append(n)
        };
        ...
        r.contentClass && u.addClass(r.contentClass),
    ...
    r.prototype.update = function(e, i) {
        ...
        i && (o = t.extend(o, i)),
        n.$.addClass("messager-" + o.type),
        e && (n.message = (o.icon ? '<i class="icon-' + o.icon + ' icon"></i> ': "") + e, n.$.find(".messager-content").html(n.message))
    },
    r.prototype.show = function(n, o) {
        ...
        a.hiding && (clearTimeout(a.hiding), a.hiding = null),
        a.update(n);
        var l = s.placement,
        c = t(s.parent),
        ...
        return a.$.show().addClass("in"),
        s.time && (a.hiding = setTimeout(function() {
            a.hide()
        },
        s.time)),
        a.isShow = !0,
...
function(t, e, i, n) {
    ...
    function s(t) {
        function e(t) {
            ...
            6 * t < 1 ? r + (s - r) * t * 6 : 2 * t < 1 ? s: 3 * t < 2 ? r + (s - r) * (2 / 3 - t) * 6 : r
        }
        var i = t.h,
        n = t.s,
        o = t.l,
    ...
    C = function(t, e, i, n) {
        var a = this;
        if (a.r = a.g = a.b = 0, a.a = 1, y(n) && (a.a = l(c(n), 1)), y(t) && y(e) && y(i)) a.r = w(t),
        a.g = w(e),
        a.b = w(i);
        else if (y(t)) {
            var r = typeof t;
            if (r == f) t = t.toLowerCase(),
            "transparent" === t ? a.a = 0 : m[t] ? this.rgb(o(m[t])) : a.rgb(o(t));
            else if ("number" == r && v(e)) a.r = a.g = a.b = w(t);
            else if (r == g && y(t.r)) a.r = w(t.r),
            y(t.g) && (a.g = w(t.g)),
            y(t.b) && (a.b = w(t.b)),
            y(t.a) && (a.a = l(c(t.a), 1));
            else if (r == g && y(t.h)) {
    ...
    C.prototype.fade = function(t) {
        return this.a = l(t / u, 1),
        this
    },
    C.prototype.spin = function(t) {
        var e = this.toHsl(),
        i = (e.h + t) % h;
        return e.h = i < 0 ? h + i: i,
        this.rgb(s(e))
    },
    ...
    C.prototype.luma = function() {
        ...
        i = this.g / p,
        n = this.b / p;
        return t = t <= .03928 ? t / 12.92 : e.pow((t + .055) / 1.055, 2.4),
        i = i <= .03928 ? i / 12.92 : e.pow((i + .055) / 1.055, 2.4),
        n = n <= .03928 ? n / 12.92 : e.pow((n + .055) / 1.055, 2.4),
        .2126 * t + .7152 * i + .0722 * n
    },
...
function(t) {
    ...
    function i(e, i, n) {
        return i = i || e.type,
        t(n || e.template).addClass("tree-action").attr(t.extend({
            "data-type": i,
            title: e.title || ""
        },
    ...
    a.prototype.add = function(e, i, n, o, a) {
        ...
        if (r.is("li") ? (s = r.children("ul"), s.length || (s = t("<ul/>"), r.append(s), this._initList(s, r))) : s = r, s) {
            ...
            function(e, i) {
                ...
                c._initItem(n, i.idx || e, s, i),
                i.children && i.children.length && c.add(n, i.children)
            }),
            this._initList(s),
            n && !s.hasClass("tree") && c.expand(s.parent("li"), o, a)
        }
    },
    ...
    a.prototype._initItem = function(n, o, a, s) {
        ...
        if (a = a || n.closest("ul"), n.attr("data-idx", o).removeClass("tree-single-item"), !n.data("id")) {
            var l = o;
            a.hasClass("tree") || (l = a.parent("li").data("id") + "-" + l),
            n.attr("data-id", l)
        }
        s = s || n.data();
        ...
        if (c) {
            ...
            d.length || (d = t('<div class="tree-actions"/>').appendTo(this.options.itemWrapper ? n.find(".tree-item-wrapper") : n), t.each(c,
            function(t, e) {
                e && d.append(i(e, t))
            }))
        }
    ...
    a.prototype._init = function() {
        ...
        r && (this.selector = n + "::" + (i.name || "") + "#" + (this.$.attr("id") || o++), this.store = t.zui.store[i.name ? "get": "pageGet"](this.selector, {})),
    ...
    a.prototype.preserve = function(e, i, n) {
        ...
        n = void 0 === n && e.hasClass("open"),
        n ? this.store[i] = n: delete this.store[i],
    ...
    a.prototype.toData = function(e, i) {
        ...
        return e.children("li:not(.tree-action-item)").map(function() {
            ...
            var a = e.children("ul");
            return a.length && (o.children = n.toData(a)),
            t.isFunction(i) ? i(o, e) : o
        }).get()
    },
    a.prototype.callEvent = function(e, i) {
        var n;
        return t.isFunction(this.options[e]) && (n = this.options[e](i, this)),
    ...
    t.fn.tree = function(e, i) {
        return this.each(function() {
            ...
            s = o.data(n),
            r = "object" == typeof e && e;
            s || o.data(n, s = new a(this, r)),
            "string" == typeof e && s[e](i)
        })
    },
    t.fn.tree.Constructor = a,
    t(function() {
